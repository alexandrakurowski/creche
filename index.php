...
?>
			     <tr>
			      ...
			      <th scope="row"><?php echo $list['children_id']; ?><button class="view_child" name="view_child"  onclick="self.location.href='child_details.php'"><img class="icon bin" src="images/view.png"></button></th>
